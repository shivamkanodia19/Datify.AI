...
ALTER PUBLICATION supabase_realtime ADD TABLE public.session_swipes;
ALTER PUBLICATION supabase_realtime ADD TABLE public.session_matches;

-- 8) Ensure full row data for realtime updates (esp. UPDATE events)
